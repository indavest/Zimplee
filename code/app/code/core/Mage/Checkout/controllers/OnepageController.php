...
class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
{
    ...
    protected $_sectionUpdateFunctions = array(
        ...
        //'shipping-method' => '_getShippingMethodsHtml', //commented for removing shipping
    ...
    public function saveBillingAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!isset($result['error'])) {
                ...
                //Commented for removing shipping
                /* elseif (isset($data['use_for_shipping']) && $data['use_for_shipping'] == 1) {
                    ...
                    //$result['goto_section'] = 'shipping'; //commented for removing shipping
                    $result['goto_section'] = 'payment'; //Replaced shipping with payment
                }
            }
    ...
    public function saveOrderAction()
    {
        ...
        try {
            ...
            //Update mylibrary table with product and its expiry depending on the number of months purchased
