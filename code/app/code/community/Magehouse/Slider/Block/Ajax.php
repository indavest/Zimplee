...
class Magehouse_Slider_Block_Ajax extends Mage_Core_Block_Template{
	public function __construct(){
		...
		if($this->loadingImage == '' || $this->loadingImage == null){
			$this->loadingImage = $this->url.'skin/frontend/base/default/images/magehouse/slider/default/ajax-loader.gif';
		}else{
			$this->loadingImage = $this->url.'skin/frontend/base/default/images/magehouse/slider/default/'.$loadingImage;
		}	
	}
